...
C17. If for some reason you are not able to use gcc the Makefile is given and the program is
simple enough for you to change the compiler options easily.
